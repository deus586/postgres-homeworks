...
SELECT customers.company_name, CONCAT(employees.first_name, ' ', employees.last_name) AS contact_name
FROM orders
...
WHERE products.units_in_stock < 25 AND products.discontinued = 0 AND categories.category_id IN (2, 4)
